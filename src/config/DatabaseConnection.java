...
public class DatabaseConnection {
    ...
    static{
        ...
        try {
            ...
            System.err.println("Advertencia: No se encontró el archivo .env o está mal configurado.\n(Dejalo en el directorio root, al lado de src, test, etc...)\nIntentando usar valores por defecto o variables de entorno del sistema.");
            // Si el .env no se encuentra, dotenv será null o vacío, y se usará System.getenv()
        }
